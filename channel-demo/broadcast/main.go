...
//
//func main() {
//	personchan := make(chan string)
//	ctx, cancelFunc := context.WithCancel(context.Background())
//
//	train := NewTrain("train", personchan, ctx)
//	car := NewCar("car", personchan, ctx)
//	plane := NewPlane("plan", personchan, ctx)
//	go train.way()
//	go car.way()
//	go plane.way()
//
//	fmt.Println("wait for 3s will send one person")
...
//	fmt.Println("wait for 2s will cancel context")
//	cancelFunc()
//
//	fmt.Println("wait for 1s will over")
